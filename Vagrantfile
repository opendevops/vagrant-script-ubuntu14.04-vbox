...
# This moves the .vagrant file out of the project folder and into an alternative location
VAGRANT_DOTFILE_PATH = 'C:\vagrant_machines\vagrant-script-ubuntu14.04-vbox'
...
Vagrant.configure(2) do |config|
  ...
  # use SMB synced folder to improve windows performance
    # :type => 'smb',
    # :smb_username => '$WINDOWS_LOGIN_USERNAME',
    # :smb_password => '$WINDOWS_LOGIN_PASSWORD'
